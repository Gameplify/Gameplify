                ...
                <div class="ui two row stackable grid">
                                <div class="column">
                                        <div class="row">
                                          ...
                                          <div id="login" class="ui segment" style="display:block; height: 360px; width: 270px; padding-top: 20px; margin-left: 40px; margin-top:0px;">
                                                                      ...
                                                                      Create an account 
                                                                       <g:link class="ui fluid large blue submit button" action="register">Register</g:link>
                                              </div> 
                                        </div> 
                                      </div>
               </div>
