					...
					<div class="ui two column stackable grid">
						<div class="column" style="width: 378px;">
							...
							<div class="ui segment"
								style="overflow: scroll; width: 392px; height: 436px; padding-left: 22px;">
									...
									<div class="rows" style="width: 325px;">
										<g:each in="${Hot}" status="i" var="game">
											<g:link action="gameProfile"
												...
												<div class="ui segment"
													style="height: 110px; width: 351px; padding-left: 30px; padding-top: 24px;">
													<a class="ui red right ribbon label 1" style="left: 240px;">
														${game.averageRating }
													</a> <img class="ui tiny left floated image"
								...
								<div class="ui three column stackable grid">
									<div class="rows" style="width: 325px;">
										<g:each in="${New}" status="i" var="gam">
											<g:link action="gameProfile"
												params="${[gameTitle: "${gam.gameTitle}"]}">
												<div class="ui segment"
													style="height: 110px; width: 351px; padding-left: 30px; padding-top: 24px;">
													<a class="ui red right ribbon label 1" style="left: 240px;">
														${gam.averageRating }
													</a> <img class="ui tiny left floated image"
														src="${resource(dir: 'images', file: "${gam.gameLogo}")}">
													<h5
														style="padding-left: 10px; margin-top: 0px; margin-bottom: 0px;">
														${gam.gameTitle }
													</h5>
...
>>>>>>> a2d0748718afae7cace6f19ba2b14b0d1719aa14
</body>
</html>
